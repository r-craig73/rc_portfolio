...
interest_heading = ["Singig Karaoke", "A love for music", "Attend live sporting events", "Attend live concerts", "Bike rides and hikes", "Wearing costumes", "If money and times were not a factor"]
