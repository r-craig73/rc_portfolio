...
interest_heading = ["Singing Karaoke", "Passionate about music", "Attending live sporting events", "Attend live concerts", "Bike rides and hikes", "Wearing costumes", "If money and time were limitless"]

interest_body = ["Singing rap, RnB, soul and country karaoke songs.", "Listening to different genres of music (rap, RnB, soul, jazz, classic rock, country, blues, anything good, etc.).", "Attending sporting events (add Timbers match pictures).  Supporting Portland and Philadelphia professional and college sports (soccer, basketball and football).", "Attending live concerts and festivals (small to medium size shows, not the stadium size concerts).", "Enjoys casual bike rides and hikes (add pictures).", "Adult Halloween (or specific theme) costume wearer (add pictures).", "Traveling across the USA and globe-treking (hopefully).  Tinkering with Python, Arduino hardware (LED lights & other sensors) and volunteering/helping people through technology."]
